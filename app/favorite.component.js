    ...
    return {
        ...
        execute: function() {
            FavoriteComponent = (function () {
                ...
                FavoriteComponent.prototype.starEvent = function () {
                    this.change.emit({ newValue: this.isFavorite });
                    this.isFavorite = !this.isFavorite;
                };
                FavoriteComponent.prototype.likeEvent = function () {
                ...
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Object)
                ], FavoriteComponent.prototype, "likes", void 0);
                __decorate([
                    core_1.Output('change-event'), 
                    __metadata('design:type', Object)
